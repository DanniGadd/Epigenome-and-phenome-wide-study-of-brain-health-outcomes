...
# These models will produce the basic EWAS results.
...
for(i in 1:(ncol(meth))){
  print(i)
  meth[,i] <- resid(lm(meth[,i] ~ phenotypes$age_stradl + as.factor(phenotypes$sex) + as.factor(phenotypes$Batch) + as.factor(phenotypes$wave) + as.factor(phenotypes$combined), na.action = na.exclude))
} 
...
fwrite(tmp, file="/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/MWAS/00_Methylation_preps/methylation_774_meth_order_basic_310121.txt", row.names=F, quote = F, sep=' ')
...
pheno1 <- read.csv("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/prep/proteins_4235_778_eGFR_included.csv", check.names = F) # colname reference file 
pheno2 <- read.csv("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/MWAS/00_Protein_preps/Phenotype_file_774.csv", check.names = F)
names(pheno2)[1] <- "ID"
pheno2 <- pheno2[-2]
...
location <- "/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/MWAS/01_Basic/batches/"
...
osca_Linux --efile /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/MWAS/00_Methylation_preps/methylation_774_meth_order_basic_310121.txt --methylation-m --make-bod --out /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/MWAS/00_Methylation_preps/methylation_774_meth_order_basic_310121
...
opi1 = read.table("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/MWAS/00_Methylation_preps/methylation_774_meth_order_basic_310121.opi", header=F, stringsAsFactors=F)
...
write.table(opi, file="/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/MWAS/00_Methylation_preps/methylation_774_meth_order_basic_310121.opi",  # make sure to keep the same filename as before
                col.names=F, 
                row.names=F, 
                quote=F, sep='\t')

# check that the annotations are present after the update
head /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/MWAS/00_Methylation_preps/methylation_774_meth_order_basic_310121.opi

# # Make ORM from methylation data - not required since we are using MOA with genetic ORM as random effect, MOA will calculate epigenetic ORM
# osca_Linux --befile /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_080421/test_files_comparison_090421/methylation_778_meth_order_basic_240521 --make-orm --out /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_080421/test_files_comparison_090421/methylation_778_meth_order_basic_240521
...
cd /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/MWAS/01_Basic/batches/batch1/
for i in *.phen 
...
cd /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/MWAS/01_Basic/batches/batch2/
for i in *.phen 
...
cd /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/MWAS/01_Basic/batches/batch3/
for i in *.phen 
...
cd /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/MWAS/01_Basic/batches/batch4/
for i in *.phen 
...
cd /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/MWAS/01_Basic/batches/batch5/
for i in *.phen 
...
cd /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/MWAS/01_Basic/batches/batch6/
for i in *.phen 
...
cd /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/MWAS/01_Basic/batches/batch7/
for i in *.phen 
...
cd /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/MWAS/01_Basic/batches/batch8/
for i in *.phen 
...
cd /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/MWAS/01_Basic/batches/batch9/
for i in *.phen 
...
cd /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/MWAS/01_Basic/batches/batch10/
for i in *.phen 
...
cd /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/MWAS/01_Basic/batches/batch11/
for i in *.phen 
...
cd /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/MWAS/01_Basic/batches/batch12/
for i in *.phen 
...
list <- c("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/MWAS/01_Basic/batches/batch1/")

sig_hits <- "/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/MWAS/01_Basic/batches/sig_hits/"
...
list <- c("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/MWAS/01_Basic/batches/batch2/")
...
list <- c("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/MWAS/01_Basic/batches/batch3/")
...
list <- c("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/MWAS/01_Basic/batches/batch4/")
...
list <- c("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/MWAS/01_Basic/batches/batch5/")
...
list <- c("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/MWAS/01_Basic/batches/batch6/")
...
list <- c("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/MWAS/01_Basic/batches/batch7/")
...
list <- c("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/MWAS/01_Basic/batches/batch8/")
...
list <- c("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/MWAS/01_Basic/batches/batch9/")
...
list <- c("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/MWAS/01_Basic/batches/batch10/")
...
list <- c("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/MWAS/01_Basic/batches/batch11/")
...
list <- c("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/MWAS/01_Basic/batches/batch12/")
...
path <- "/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/MWAS/01_Basic/batches/sig_hits/"
...
dim(comb2_filt2) # 133688  - at cpg/protein adjusted significance 
comb2 <- comb2_filt2[order(comb2_filt2$p),]
write.csv(comb2, "/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/MWAS/00_Results_collation/pQTL_EWAS_results_020221.csv", row.names = F)
...
# ### TROUBLESHOOTING NON CONVERGED MODELS 

# ##############################################################################################

# # Work out which are missing from the basic model 
...
# path <- "/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_200721/basic_no_eGFR/batches/sig_hits/"
...
# # # Write these phenotype files to a separate troubleshooting location to run iterations on 

# # location <- "/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/Troubleshooting/basic/"

# # ## Write out protein files so FID, IID, phenotype 
# # for(i in 1:8){ 
# # name <- names(list2)[i]
# # write.table(list2[,c("FID","IID",name)], file = paste0(location, name,".phen"), col.names = F, row.names=F, quote = F, sep=' ')
# # }


# # # Now do all 8 to see where issues lie 

# # cd /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/Troubleshooting/basic/
# # for i in *.phen 
...
# # osca_Linux --moa --orm /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_080421/relatedness_testing_140421/daniel_orm/ormtest778 --befile /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_080421/test_files_comparison_090421/methylation_778_meth_order_basic_240521 --pheno $i --fast-linear --out ${B}_MOA_778_with_ORM --methylation-m


# # done 


# # # Run the models with just epigenetic ORM to see whether there are clues about non-convergence there 
...
# # osca_Linux --moa --befile /Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/EWAS_4000/EWAS_080421/test_files_comparison_090421/methylation_778_meth_order_basic_240521 --pheno $i --fast-linear --out ${B}_MOA_778_epi_ORM --methylation-m


# # done 

# # # Run with just genetic ORM in GWAS to see what outcome is 
