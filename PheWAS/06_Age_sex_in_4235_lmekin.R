...
for(i in 1:500){
  ...
  mod <- lmekin(scale(prot[,prot_name]) ~ scale(prot$st_age) + as.factor(prot$sex) + as.factor(prot$combined) + (1|prot$GS_id), data = prot, varlist = kin_model*2)
...
write.csv(results, "/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/age_b1.csv", row.names = F)
write.csv(results2, "/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/sex_b1.csv", row.names = F)
...
# save a copy of results tables 
write.csv(results, "/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/age_b2.csv", row.names = F)
write.csv(results2, "/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/sex_b2.csv", row.names = F)
...
# save a copy of results tables 
write.csv(results, "/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/age_b3.csv", row.names = F)
write.csv(results2, "/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/sex_b3.csv", row.names = F)
...
# batch 4
# save a copy of results tables 
write.csv(results, "/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/age_b4.csv", row.names = F)
write.csv(results2, "/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/sex_b4.csv", row.names = F)
...
# save a copy of results tables 
write.csv(results, "/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/age_b5.csv", row.names = F)
write.csv(results2, "/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/sex_b5.csv", row.names = F)
...
# save a copy of results tables 
write.csv(results, "/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/age_b6.csv", row.names = F)
write.csv(results2, "/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/sex_b6.csv", row.names = F)
...
# save a copy of results tables 
write.csv(results, "/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/age_b7.csv", row.names = F)
write.csv(results2, "/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/sex_b7.csv", row.names = F)
...
# save a copy of results tables 
write.csv(results, "/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/age_b8.csv", row.names = F)
write.csv(results2, "/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/sex_b8.csv", row.names = F)
...
# save a copy of results tables 
write.csv(results, "/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/age_b9.csv", row.names = F)
write.csv(results2, "/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/sex_b9.csv", row.names = F)
...
e1 <- read.csv("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/age_b1.csv")
e2 <- read.csv("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/age_b2.csv")
e3 <- read.csv("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/age_b3.csv")
e4 <- read.csv("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/age_b4.csv")
e5 <- read.csv("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/age_b5.csv")
e6 <- read.csv("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/age_b6.csv")
e7 <- read.csv("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/age_b7.csv")
e8 <- read.csv("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/age_b8.csv")
e9 <- read.csv("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/age_b9.csv")
...
e1 <- read.csv("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/sex_b1.csv")
e2 <- read.csv("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/sex_b2.csv")
e3 <- read.csv("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/sex_b3.csv")
e4 <- read.csv("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/sex_b4.csv")
e5 <- read.csv("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/sex_b5.csv")
e6 <- read.csv("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/sex_b6.csv")
e7 <- read.csv("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/sex_b7.csv")
e8 <- read.csv("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/sex_b8.csv")
e9 <- read.csv("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/batches/sex_b9.csv")
...
write.csv(results, "/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/age_results_file.csv", row.names = F)
write.csv(results2, "/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/02_Age_sex/sex_results_file.csv", row.names = F)
