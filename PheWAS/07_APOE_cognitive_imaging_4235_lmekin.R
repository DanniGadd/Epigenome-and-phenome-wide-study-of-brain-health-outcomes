...
for (j in 1:length(phenotype)){
  ...
  write.csv(results, paste0("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/03_Cognitive/batches/", pheno, "_result.csv"))
}
...
for (j in 1:length(set)){
  ...
  write.csv(results, paste0("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/04_APOE/batches/e2_b1.csv"), row.names = F)
}
...
for (j in 1:length(set)){
  ...
  write.csv(results, paste0("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/04_APOE/batches/e2_b2.csv"), row.names = F)
}
...
for (j in 1:length(set)){
  ...
  write.csv(results, paste0("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/04_APOE/batches/e2_b3.csv"), row.names = F)
}
...
for (j in 1:length(set)){
  ...
  write.csv(results, paste0("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/04_APOE/batches/e2_b4.csv"), row.names = F)
}
...
for (j in 1:length(set)){
  ...
  write.csv(results, paste0("/Cluster_Filespace/Marioni_Group/Danni/Stradl_markers/00_Revisions_updates/PheWAS/04_APOE/batches/e2_b5.csv"), row.names = F)
}
...
for (j in 1:length(phenotype)){
  ...
  for(i in 1:4235){
    tryCatch({ 
      ...
      mod <- lmekin(scale(prot[,prot_name]) ~ scale(prot$st_age) + as.factor(prot$sex) + scale(prot[,pheno]) + as.factor(prot$combined) + as.factor(prot$Site) + (1|prot$GS_id), na.action = na.exclude, data = prot, varlist = kin_model*2)
...
for (j in 1:length(phenotype)){
  ...
  for(i in 1:4235){
    tryCatch({ 
      ...
      mod <- lmekin(scale(prot[,prot_name]) ~ scale(prot$st_age) + as.factor(prot$sex) + scale(prot[,pheno]) + as.factor(prot$combined) + as.factor(prot$Site)*prot$Estimated_ICV + as.factor(prot$Edited) + as.factor(prot$Batch) + (1|prot$GS_id), na.action = na.exclude, data = prot, varlist = kin_model*2)
...
for (j in 1:length(phenotype)){
  ...
  for(i in 1:4235){
    tryCatch({ 
      ...
      mod <- lmekin(scale(prot[,prot_name]) ~ scale(prot$st_age) + as.factor(prot$sex) + scale(prot[,pheno]) + as.factor(prot$combined) + (1|prot$GS_id), na.action = na.exclude, data = prot, varlist = kin_model*2)
